  ...
  const locations: Location[] = [
    {
      ...
      address: "1216 Asuncion St, Tondo, City Of Manila, 1012 Metro Manila, Philippines",
      phone: "(02) 8555-1234",
      hours: {
      ...
      <section className="relative bg-gradient-to-br from-red-800 via-red-700 to-orange-600 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto text-orange-100 leading-relaxed">
            ...
            <br />Premium dining, exceptional service, unforgettable flavors.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Located in the heart of Metro Manila, experience premium Korean BBQ
            </p>
          </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="group">
                        ...
                        <p className="text-gray-300 ml-16 leading-relaxed">{location.address}</p>
                      </div>
                      ...
                      <div className="group">
                        ...
                        <div className="ml-16 space-y-2">
                          {Object.entries(location.hours).map(([days, hours]) => (
                            <div key={days} className="flex justify-between items-center bg-gray-800/50 rounded-lg px-4 py-2">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="bg-gray-800/50 rounded-xl p-4 mb-4">
                    <p className="text-gray-200 text-lg font-medium mb-2">{method.details}</p>
                    <p className="text-yellow-400 text-sm font-semibold uppercase tracking-wider">{method.hours}</p>
                  </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start group/item">
                    ...
                    <p className="text-gray-300 leading-relaxed group-hover/item:text-white transition-colors">{item}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 text-orange-200">
            <p className="text-sm uppercase tracking-wider font-semibold">
              ✨ Premium Korean BBQ Experience • Since 2024 ✨
            </p>
          </div>
        </div>
      </section>
